...
jq '.channel_group.groups.Application.groups."dealer-fish-com".values += {"AnchorPeers":{"mod_policy": "Admins","value":{"anchor_peers": [{"host": "192.168.1.91","port": 7003}]},"version": "0"}}' voucherchannel_current_config.json > voucherchannel_modified_anchor_config.json
